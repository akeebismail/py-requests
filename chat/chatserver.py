...
class CommandHandler:
    """
    Simple Command handler similar to cmd.Cmd from standard library
    """
...
class Room(CommandHandler):
    ...
    It takes care of the basic command handling and broadcasting.
    """
...
class LoginRoom(Room):
    ...
    def add(self, session):
        ...
        # When a user enters, great him/her
